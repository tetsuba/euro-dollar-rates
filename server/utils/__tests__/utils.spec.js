...
describe.skip('utils', () => {
  ...
  describe('readJsonFile()', () => {
    ...
    test('should return mock data', async () => {
      ...
      await expect(readJsonFile(filePath, defaultData))
    ...
    test('should throw an error if reading a file fails', async () => {
      ...
      await expect(readJsonFile(filePath, defaultData))
        .rejects
        .toThrow('File System Error: READ')
    })
  })
  describe('saveJsonFile()', () => {
    ...
    test('should throw an error if writing a file fails', async () => {
      ...
      await expect(saveJsonFile('path', mockJson))
        .rejects
        .toThrow('File System Error: WRITE')
    })
  })
  describe('deleteFile()', () => {})
})