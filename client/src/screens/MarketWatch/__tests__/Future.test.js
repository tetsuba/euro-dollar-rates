...
const mockData = {
  data: {
    list: [
      { year: 2021, month: '06', price: '1,000,000.50', name: 'Eurodollar 3 Month Jun 2021', symbol: 'EDM21' },
      { year: 2010, month: '06', price: '100,000', name: 'Eurodollar 3 Month Jun 2010', symbol: 'EDM10' },
      { year: 1999, month: '06', price: '1,000', name: 'Eurodollar 3 Month Jun 1999', symbol: 'EDM99' },
      { year: 2001, month: '06', price: '10,000', name: 'Eurodollar 3 Month Jun 2000', symbol: 'EDM01' },
    ]
  }
}
...
describe('Future',() => {
  ...
  const rendered = render(
    <MemoryRouter initialEntries={['', { pathname: '/market-watch/futures/ED' }]}>
      <Future />
    </MemoryRouter>
  )
  ...
  test('should render',  async () => {
    ...
    await waitFor(() => expect(rendered.getByTestId('future-checkbox-list')))
