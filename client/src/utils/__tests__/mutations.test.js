...
describe('mutations', () => {
  ...
  describe('Future(s)List', () => {
    ...
    describe('mutateFuturesListByGroupingNames()', () => {
      const mockList = ['ED2300', 'SIR00', 'EDH24', 'EDM24', 'EDQ24', 'OLM22']
      const expectedList = ['ED', 'OL']

      test('', () => {
        expect(mutateFuturesListByGroupingNames(mockList)).toEqual(expectedList)
      })
    })
  })
  ...
  describe('FutureList', () => {
    describe('mutateFutureList()', () => {
      test('should return list with a new property and sorted by year', () => {
        ...
        const expectedList = [
          ...
          { year: 2010, month: '06', price: '100,000', checked: true },
          { year: 2021, month: '08', price: '1,000,000.50', checked: true },
        ]
    ...
    describe('mutateFutureStringToObject()', () => {
      test('should return an object', () => {
        const mockData = {name: 'Eurodollar 3 Month Jun 2029', price: '100'}
        const expected = {
          month: 'Jun',
          year: '2029',
          price: '100',
