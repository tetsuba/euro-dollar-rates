...
describe('BreadCrumbs', () => {
    ...
    function expectBreadCrumb({ TEXT, PATH }: Crumb, active: boolean): void {
    ...
    test('location path "/"', () => {
        render(
            <MemoryRouter
                initialEntries={['', { pathname: BREADCRUMB.HOME.PATH }]}
            >
                <BreadCrumbs />
            </MemoryRouter>
        )
    ...
    test('location path "/path1"', () => {
        render(
            <MemoryRouter
                initialEntries={['', { pathname: BREADCRUMB.PATH1.PATH }]}
            >
                <BreadCrumbs />
            </MemoryRouter>
        )
    ...
    test('location path "/path1/path2"', () => {
        render(
            <MemoryRouter
                initialEntries={['', { pathname: BREADCRUMB.PATH2.PATH }]}
            >
                <BreadCrumbs />
            </MemoryRouter>
        )
    ...
    test('location path "/path1/path2/path3"', () => {
        render(
            <MemoryRouter
                initialEntries={['', { pathname: BREADCRUMB.PATH3.PATH }]}
            >
                <BreadCrumbs />
            </MemoryRouter>
        )
